// $Id: Misc.cpp,v 1.2 2025/02/09 21:24:33 administrateur Exp $

#include <Arduino.h>

#include "Misc.h"

/* Definition et methode de calcul incrementale de la checksum d'un buffer identique a 'cksum' de UNIX
...
uint32_t cksum_inc(const uint8_t *i__datas, size_t i__size, uint32_t i__crc_tmp, size_t i__size_cumul)
{
  uint32_t l__crc = 0;
